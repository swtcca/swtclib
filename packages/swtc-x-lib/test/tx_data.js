...
const input1 = {
    ...
    tx: {
        ...
        Sequence: 1293,
        SigningPubKey: '03B35A1F42C4A01BD3E79B8CA1BE1F05661375BF557F5EEACA8EF699669702DC54',
        Timestamp: 588967263,
        TransactionType: 'Payment',
        TxnSignature: '3045022100F507E42104CD93D00B1429B7514D76E4FC058E993EF299CB4CC34E02482F3FAA022007636929A141D226C1615DACA9AD9E37B3D7A5041CA5226E5195366735BA481B',
        date: 588967270,
...
const input6 = {
    ...
    tx: {
        ...
        OfferSequence: 4581,
        Sequence: 4582,
        SigningPubKey: '030FC8DDB7C7CBB7E2D031B82D480C8B90692DCDF142B229CC18C544C09BD66FBE',
        TransactionType: 'OfferCancel',
        TxnSignature: '3045022100CEC38432000E9A637920541C4868E412D649ED8048269A67F0B4FF2C6C9CB62A02205C7E1222C13B41DA0D8F0DEDA8B997FC5834F08FE1BDF196F71E369376074635',
        date: 588934000,
...
const input7 = {
    ...
    tx: {
        ...
        TxnSignature: '304402206B5CC4C716473E38E677C7F97663BE7C00DE47F7377E26B1246356CDDC8F2A5E02203C7F5A318183C5275F580C932EB92CBAC9007FB866D5C2B37A0E912DDFC6334C',
        date: 588934160,
...
const input8 = {
    ...
    tx: {
        ...
        TransactionType: 'OfferCreate',
        TxnSignature: '304502210096928D82EDB2067F72E5BED86356BC6EF513BF6B5022E2FCBCD3FD890839BC4402205364BFF48FAAB90E25D5299D11CA2E01EECDF5554F091DE733C979168B4ADF4F',
        date: 590310500,
...
const input17 = {
    ...
    Sequence: 30454,
    SigningPubKey: '03701F8B681517BE6DE4321C5FB173328C4FA0677CAA72E91D069534675BD13C25',
    TakerGets: {
        currency: 'JJCC',
        issuer: 'jGa9J9TkqtBcUoHe2zqhVFFbgUVED6o9or',
        value: '1841'
    ...
    Timestamp: 585665044,
    TransactionType: 'OfferCreate',
    TxnSignature: '30440220550420FAC7979F4EBF3D8446A2928C553B26670F4A037DB978D20DDD2E52CEC102205B41C103C4537A2178BD2C7E1761A2D217682AE6DE5912A24106A14D6D6EE2BB',
    date: 585665050,
    ...
    meta: {
        AffectedNodes: [{
            ModifiedNode: {
                ...
                PreviousTxnID: '8C62CDFD2ADD995337EF5AA77B4DA8C6DD1744BA38008140C68D82D41437E1D1',
            ...
            DeletedNode: {
                FinalFields: {
                    Account: testAddress,
                    BookDirectory: 'EEDDF861497F1B773BEB9A16C0E0C8D77E93204DA28748EB5508E1BC9BF04000',
                    BookNode: '0000000000000000',
                    Flags: 0,
                    OwnerNode: '0000000000000001',
                    PreviousTxnID: '0D5B0658C92E2F28FF6360AD8621D66F1F562F483C169D025548CA131A2677A7',
                ...
                LedgerEntryType: 'Offer',
                LedgerIndex: 'CA0AB136B2F40CDB81206518ADEEB7E9E93565E7FBD208785CAAE9009ECEAD7B'
            }
        }],
        TransactionIndex: 3,
        TransactionResult: 'tesSUCCESS'
...
const input18 = {
    ...
    meta: {
        AffectedNodes: [{
            CreatedNode: {
                LedgerEntryType: 'Offer',
                LedgerIndex: '703733408780DC3344D48EFD5EE42D6095C93D37130C80E2B220A5CEE9770FDC',
                NewFields: {
                    Account: testAddress,
                    BookDirectory: 'EEDDF861497F1B773BEB9A16C0E0C8D77E93204DA28748EB5508E1BC9BF04000',
                    OwnerNode: '0000000000000001',
    ...
    meta: {
        AffectedNodes: [{
            DeletedNode: {
                ...
                PreviousTxnID: 'D6314BDE941C25CE66F26355A50D027146D1C4D4442CEA086A8C5CF206ADF67F',
                LedgerEntryType: 'Offer',
                LedgerIndex: 'CA0AB136B2F40CDB81206518ADEEB7E9E93565E7FBD208785CAAE9009ECEAD7B'
            }
        }, {
    ...
    meta: {
        AffectedNodes: [{
            ModifiedNode: {
                ...
                LedgerIndex: '0E5BAB543168C6458A36E99AD88A868C32218BC18E4796F5FB6EEDDA9A816165',
                PreviousFields: {
            ...
            ModifiedNode: {
                FinalFields: [{
                    Account: testAddress,
                    BookDirectory: 'EC6ECEC8051D20F4A03B1944C5FC468500B9459A04068FF94D07E5196E2AE38E',
                    BookNode: '0000000000000000',
                    Flags: 0,
                    OwnerNode: '0000000000000001',
                    Sequence: 4335,
                ...
                LedgerEntryType: 'Offer',
                LedgerIndex: '78E56FF59046ED314E455592AF62C998F0C1EFD12C867ECFAF40E294A9191A4B',
                PreviousFields: [{
            ...
            ModifiedNode: {
                ...
                LedgerEntryType: 'AccountRoot',
                LedgerIndex: '89A83145155F38F60A58D6A6F1184291BBAD10DDC7018A4873E88BAC127C4F31',
                PreviousFields: [{
            ...
            ModifiedNodes: {
                ...
                LedgerIndex: 'DD28F001E1CBEB8E02911176777684413D5C42DBEA92B800F48F8DAD6027CE5B',
                PreviousFields: [{
                    Balance: {
                        currency: 'JJCC',
                        issuer: 'jjjjjjjjjjjjjjjjjjjjBZbvri',
